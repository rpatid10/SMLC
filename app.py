...
try:
    ...
    st.error(
        "Model files not found. Run the notebook once (Section 10 saves "
        "`cardioguard_pipeline.pkl` and `cardioguard_explainer.pkl`) and place them next to "
        "this app.py before launching Streamlit."
    )
    st.stop()
